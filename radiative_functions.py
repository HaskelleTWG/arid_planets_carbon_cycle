...
## This complicated looking set of functions is  just a climate model (i.e. it takes H2O, CO2, T_surface, and returns the outgoing longwave radiation (OLR))
## This can be called iteratively to find the surface temperature that balances OLR and incoming solar radiation.
